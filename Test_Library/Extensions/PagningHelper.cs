...
{
    public static class PagningHelper
    {
        public static IHtmlContent PagingFooter(this IHtmlHelper htmlHelper, int totalPage, int currentPage, int itemsPerPageingFooter, string cssClass, Func<int, string> pageUrl)
        {
